...
You can see all the changes here: [1.7.1...moodlemobile:v1.7.1-moodle.4](https://github.com/apache/cordova-plugin-file-transfer/compare/1.7.1...moodlemobile:v1.7.1-moodle.4)
...
```sh
cordova plugin add @moodlehq/cordova-plugin-file-transfer@1.7.1-moodle.4
```
